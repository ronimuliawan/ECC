...
const SUPPORTED_INSTALL_TARGETS = ['claude', 'claude-project', 'commandcode', 'cursor', 'antigravity', 'codex', 'gemini', 'opencode', 'codebuddy', 'joycode', 'qwen', 'zed', 'hermes', 'openclaw', 'kimi'];
